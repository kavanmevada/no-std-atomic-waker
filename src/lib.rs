...
/// use core::futures::task::{Context, Poll, AtomicWaker};
/// use core::sync::Arc;
    ...
    pub fn register(&self, waker: &Waker) {
            ...
            .compare_exchange(WAITING, REGISTERING, AcqRel, Acquire)
        {
                    ...
                    *self.waker.get() = Some(waker.clone());
                    ...
                    match res {
                        ...
                        Err(actual) => {
                            ...
                            // `WAKING`.
                            assert_eq!(actual, REGISTERING | WAKING);
            ...
            state => {
                ...
                // call to `register`.
                assert!(state == Ok(REGISTERING) || state == Ok(REGISTERING | WAKING));
            }
        }
    }
    ...
    pub fn take(&self) -> Option<Waker> {
        ...
        match self.state.fetch_or(WAKING, AcqRel) {
            ...
            state => {
                ...
                // not.
                //
                assert!(state == REGISTERING || state == REGISTERING | WAKING || state == WAKING);
                None
            }
        }
    }
